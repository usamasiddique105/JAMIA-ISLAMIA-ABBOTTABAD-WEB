...
const TAB_SEO_MAP: Record<string, SEOData> = {
  home: {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول (Home)', item: 'https://jamia-islamia-abbottabad.ai.studio/' }
    ]
  },
  fatwas: {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'دار الافتاء و فتاویٰ (Darul Ifta)', item: 'https://jamia-islamia-abbottabad.ai.studio/#fatwas' }
    ]
  },
  'fatwa-duas': {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'دار الافتاء', item: 'https://jamia-islamia-abbottabad.ai.studio/#fatwas' },
      { name: 'مسنون دعائیں', item: 'https://jamia-islamia-abbottabad.ai.studio/#fatwa-duas' }
    ]
  },
  'fatwa-names': {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'دار الافتاء', item: 'https://jamia-islamia-abbottabad.ai.studio/#fatwas' },
      { name: 'اسلامی نام', item: 'https://jamia-islamia-abbottabad.ai.studio/#fatwa-names' }
    ]
  },
  results: {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'امتحانی نتائج (Results)', item: 'https://jamia-islamia-abbottabad.ai.studio/#results' }
    ]
  },
  'online-quran': {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'آن لائن قرآنی تعلیم (Online Quran)', item: 'https://jamia-islamia-abbottabad.ai.studio/#online-quran' }
    ]
  },
  'online-dars-nizami': {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'آن لائن درسِ نظامی و تفسیر', item: 'https://jamia-islamia-abbottabad.ai.studio/#online-dars-nizami' }
    ]
  },
  'online-services': {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'آن لائن تعلیمی خدمات (Online Courses)', item: 'https://jamia-islamia-abbottabad.ai.studio/#online-services' }
    ]
  },
  library: {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'دیجیٹل لائبریری (Library)', item: 'https://jamia-islamia-abbottabad.ai.studio/#library' }
    ]
  },
  donations: {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'عطیات و زکوۃ (Donations)', item: 'https://jamia-islamia-abbottabad.ai.studio/#donations' }
    ]
  },
  about: {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'جامعہ کا تعارف (About Us)', item: 'https://jamia-islamia-abbottabad.ai.studio/#about' }
    ]
  },
  contact: {
    ...
    breadcrumbs: [
      { name: 'صفحہ اول', item: 'https://jamia-islamia-abbottabad.ai.studio/#home' },
      { name: 'رابطہ کریں (Contact Us)', item: 'https://jamia-islamia-abbottabad.ai.studio/#contact' }
    ]
  }
};
...
export const SEOHead: React.FC<SEOHeadProps> = ({ currentTab }) => {
  ...
  useEffect(() => {
    ...
    updateMeta('meta[property="og:url"]', 'property', 'og:url', `https://jamia-islamia-abbottabad.ai.studio/#${currentTab}`);
    ...
    canonical.setAttribute('href', `https://jamia-islamia-abbottabad.ai.studio/#${currentTab}`);
