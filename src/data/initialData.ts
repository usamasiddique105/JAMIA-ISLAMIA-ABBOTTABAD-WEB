...
export const INITIAL_DONATIONS: DonationRecord[] = [
  {
    id: 'don-1',
    donorName: 'حاجی محمد رفیق',
    donorEmail: 'm.rafiq@yahoo.com',
    donorPhone: '+923001234567',
    fundType: 'Zakat',
    amount: 150000,
    currency: 'PKR',
    paymentMethod: 'Bank Transfer',
    transactionRef: 'MEZ-88492019',
    date: '2026-07-10',
    status: 'Verified'
  },
  {
    id: 'don-2',
    donorName: 'تنویر احمد (برطانیہ)',
    donorEmail: 'tanveer.uk@gmail.com',
    donorPhone: '+447911123456',
    fundType: 'Building Fund',
    amount: 500,
    currency: 'GBP',
    paymentMethod: 'Credit Card',
    transactionRef: 'STR-99102834',
    date: '2026-07-18',
    status: 'Verified'
  }
];
...
export const INITIAL_CLASS_BOOKINGS: ClassBooking[] = [
  {
    id: 'book-1',
    bookingType: 'Trial',
    studentName: 'محمد عبد اللہ',
    guardianName: 'عمران خان',
    age: '12',
    country: 'برطانیہ (UK)',
    phone: '+447912345678',
    whatsapp: '+447912345678',
    email: 'imran.uk@gmail.com',
    course: 'آن لائن قرآن کریم (تجوید و حفظ)',
    preferredTime: 'شام 06:00 تا 07:00 بجے (UK Time)',
    date: '2026-08-17',
    status: 'Pending',
    adminNotes: '۳ روزہ مفت ٹرائل کی درخواست موصول ہوئی ہے۔'
  },
  {
    id: 'book-2',
    bookingType: 'Admission',
    studentName: 'احمد حسن زبیر',
    guardianName: 'زبیر احمد',
    age: '19',
    country: 'سعودی عرب (KSA)',
    phone: '+966501234567',
    whatsapp: '+966501234567',
    email: 'zubair.ksa@hotmail.com',
    course: 'مکمل آن لائن درس نظامی (عالم کورس)',
    preferredTime: 'رات 09:00 بجے',
    date: '2026-08-16',
    status: 'Contacted',
    adminNotes: 'واٹس ایپ پر رابطہ کیا گیا، ٹائم ٹیبل بھیج دیا گیا ہے۔',
    replyMessage: 'وعلیکم السلام، آپ کا درس نظامی کا داخلہ پروسیس کیا جا رہا ہے۔ پیر سے پہلی کلاس شیڈول ہے۔',
    replyDate: '2026-08-16'
  },
  {
    id: 'book-3',
    bookingType: 'Trial',
    studentName: 'زینب فاطمہ',
    guardianName: 'طارق محمود',
    age: '10',
    country: 'امریکہ (USA)',
    phone: '+14085551234',
    whatsapp: '+14085551234',
    email: 'tariq.us@yahoo.com',
    course: 'آن لائن عربی زبان و گرائمر',
    preferredTime: 'صبح 10:00 بجے (EST)',
    date: '2026-08-15',
    status: 'Confirmed',
    adminNotes: 'فیمیل استانی (معلمہ) کی کلاس شیڈول ہو چکی ہے۔',
    replyMessage: 'السلام علیکم، آپ کے لیے معلمہ کا انتخاب کر دیا گیا ہے۔ زوم لنک ارسال کر دیا گیا ہے۔',
    replyDate: '2026-08-15'
  }
];
